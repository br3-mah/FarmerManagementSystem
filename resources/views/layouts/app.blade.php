...
<!-- Mirrored from themewagon.github.io/skydash/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 19 Dec 2024 09:44:06 GMT -->
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="tables">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="pages/tables/basic-table.html">Packages</a></li>
              </ul>
            </div>
          </li>
          {{--<li class="nav-item">
      ...
      <div class="main-panel">
        ...
        <footer class="footer">
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2021.  Premium <a href="../../www.bootstrapdash.com/index.html" target="_blank">Bootstrap admin template</a> from BootstrapDash. All rights reserved.</span>
            <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">Hand-crafted & made with <i class="ti-heart text-danger ml-1"></i></span>
          </div>
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Distributed by <a href="../../www.themewagon.com/index.html" target="_blank">Themewagon</a></span>
          </div>
        </footer>
        <!-- partial -->
      </div>
