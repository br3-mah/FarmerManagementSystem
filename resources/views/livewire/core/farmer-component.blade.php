                        ...
                        <tbody>
                            @foreach ($farmers as $farmer)
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-primary btn-sm" wire:click="viewFarmer({{ $farmer->id }})">View</button>
                                        <button class="btn btn-warning btn-sm" wire:click="editFarmer({{ $farmer->id }})">Edit</button>
